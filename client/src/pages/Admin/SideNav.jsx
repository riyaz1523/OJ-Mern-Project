...
export default function SideNav() {
  return (
    <div className="bg-dark-layer-2 text-white">
      ...
      <aside
        id="default-sidebar"
        className=" top-25 left-0 z-40 w-64 h-screen bg-gray-8 transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4  overflow-y-auto text-white">
          <ul class="space-y-2 font-medium ">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-white rounded-lg text-white "
              >
                <svg
            ...
            <li className="text-white">
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap text-white">Users List</span>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Users List</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 18 16"
